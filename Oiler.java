...
public class Oiler extends Foodcontainer {

    private String surface;
    private Size sizeOfSurface;
    private String typeOfFrame;

    public Oiler(String surface, Size sizeOfSurface, String typeOfFrame,
                 double material, Color color, double weight, String producer,
                 Material material) {
